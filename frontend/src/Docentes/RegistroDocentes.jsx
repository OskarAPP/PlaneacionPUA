      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center py-8 overflow-auto bg-gray-100 text-gray-900">
          <div className="w-full max-w-5xl">
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-b-md p-6 flex flex-col gap-6" autoComplete="off">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" name="nombre" value={form.nombre} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300" required />
                </div>
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Apellido Paterno: <span className="text-red-500">*</span></label>
                  <input type="text" name="apellido_paterno" value={form.apellido_paterno} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300" required />
                </div>
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Apellido Materno:</label>
                  <input type="text" name="apellido_materno" value={form.apellido_materno} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Facultad: <span className="text-red-500">*</span></label>
                  <select name="facultad_id" value={form.facultad_id} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300" required>
                ...
                <div>
                  ...
                  <input type="email" name="correo" value={form.correo} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-blue-50 text-gray-900 border-gray-300" required autoComplete="email" />
                </div>
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Contraseña: <span className="text-red-500">*</span></label>
                  <input type="password" name="contrasena" value={form.contrasena} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-blue-50 text-gray-900 border-gray-300" required autoComplete="new-password" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Titulo:</label>
                  <input type="text" name="titulo" value={form.titulo} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300" />
                </div>
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Cargo: <span className="text-red-500">*</span></label>
                  <select name="cargo_id" value={form.cargo_id} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300">
                ...
                <div>
                  <label className="block text-gray-700 font-semibold mb-1">Rol: <span className="text-red-500">*</span></label>
                  <select name="rol_id" value={form.rol_id} onChange={handleChange} className="w-full border rounded px-3 py-2 bg-white text-gray-900 border-gray-300">
