      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center py-8 overflow-auto">
          <div className="w-full max-w-5xl">
            <div className="bg-[#3578b3] text-white text-lg font-semibold rounded-t-md px-4 py-2 text-center mb-2">Registro de Competencia Específica</div>
            <div className="bg-white border rounded-b-md p-6 flex flex-col gap-6">
              <form className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                <div>
                  <label className="block text-gray-800 font-bold mb-1">Competencia Específica:</label>
                ...
                <div>
                  <label className="block text-gray-800 font-bold mb-1">Carrera:</label>
                  <select className="w-full border rounded px-3 py-2 text-gray-700">
                ...
                <div className="md:col-span-3 flex justify-center mt-2">
                  <button type="submit" className="w-1/2 bg-[#3578b3] hover:bg-[#285a8c] text-white font-semibold rounded px-4 py-2 transition-colors">Registrar</button>
                </div>
              </form>
            </div>
          </div>
