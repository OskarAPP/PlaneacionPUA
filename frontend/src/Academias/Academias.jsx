            ...
            <div className="bg-white border border-gray-200 rounded-b-md p-4 flex flex-col md:flex-row md:items-end gap-4 mb-4">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Nombre de la Academia" className="pl-10 pr-3 py-2 border rounded w-full focus:outline-none bg-white border-gray-300 text-gray-900" />
                </div>
              </div>
              <div className="flex-1 md:max-w-xs">
                <label className="block text-gray-700 font-semibold mb-1">Ordenar alfabéticamente por:</label>
                <select className="w-full border rounded px-3 py-2 bg-white border-gray-300 text-gray-900">
                  <option>A a Z</option>
                  <option>Z a A</option>
                </select>
              </div>
                  ...
                  <tbody>
                    {academias.length === 0 ? (
                      ...
                      academias.map((row, idx) => (
                        <tr key={row.academia_id} className="hover:bg-gray-100">
                          ...
                          <td className="border border-[#b5d6ea] px-3 py-2">{row.facultad_nombre || '-'}</td>
                        </tr>
                      ))
                    )}
                  </tbody>
