...
const Sidebar = ({
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-full w-64 bg-white shadow-xl transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out z-50 overflow-y-auto max-h-screen custom-scrollbar border-r border-gray-200`}
      ...
      <nav className="p-4 space-y-2">
        ...
        <div ref={refs.facultadRef} data-key="facultad">
          ...
          {dropdownOpen['facultad'] && (
            <div className="ml-4 mt-2 space-y-2">
              <a href="/facultades" className="block p-2 text-sm text-blue-700 hover:bg-blue-100 rounded-md">Facultades registradas</a>
        ...
        <div ref={refs.bibliotecaRef} data-key="biblioteca">
          <button onClick={() => toggleDropdown('biblioteca')} className="w-full flex items-center justify-between p-3 rounded-lg bg-white border border-blue-700 text-blue-700 hover:bg-blue-50 hover:border-blue-800 font-medium transition-colors">
        ...
        <div ref={refs.cuentaRef}>
          ...
          {cuentaOpen && (
            <div className="absolute left-0 mt-2 w-full bg-white border border-blue-200 rounded shadow-lg z-50 animate-fade-in">
              <a href="/panelacceso" className="block p-2 text-sm text-blue-700 hover:bg-blue-100 rounded-md" onClick={() => window.location.href = '/panelacceso'}>Inicio</a>
              <a href="/perfilusuario" className="block p-2 text-sm text-blue-700 hover:bg-blue-100 rounded-md">Perfil</a>
