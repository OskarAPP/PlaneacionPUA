      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center py-8 overflow-auto bg-gray-100 text-gray-900">
          <div className="w-full max-w-5xl">
            ...
            {/* Lista de carreras */}
            <div className="bg-blue-100 text-blue-900 text-center font-semibold rounded-t-md py-2 mb-0.5">Lista de Carreras</div>
            <div className="overflow-x-auto bg-white rounded-b-md shadow">
              <table className="min-w-full text-sm text-left text-blue-900">
                ...
                <tbody className="text-blue-900">
                  {loading ? (
                    <tr><td colSpan="5" className="text-center py-4 text-blue-700">Cargando...</td></tr>
                  ) : error ? (
                    ...
                    filteredCarreras.map((carrera, idx) => (
                      <tr key={carrera.carrera_id} className="border-b hover:bg-blue-50">
