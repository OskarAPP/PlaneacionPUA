      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center py-8 overflow-auto">
          <div className="w-full max-w-5xl">
            ...
            <div className="bg-white border border-gray-200 rounded-b-md p-4 flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="w-full pl-10 pr-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white border-gray-300 text-gray-900"
            ...
            {/* Lista de facultades */}
            <div className="bg-blue-100 text-blue-900 text-center font-semibold rounded-t-md py-2 mb-0.5">Lista de facultades</div>
            <div className="overflow-x-auto bg-white rounded-b-md shadow">
              {loading ? (
                <div className="text-center text-blue-700 py-4">Cargando...</div>
              ) : error ? (
                ...
                <table className="min-w-full text-sm text-left text-blue-900">
                  ...
                  <tbody className="text-blue-900">
                    {filteredFacultades.map((facultad, idx) => (
                      <tr key={facultad.facultad_id} className="border-b hover:bg-blue-50">
